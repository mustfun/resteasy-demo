package com.dzy.resteasy.support.config;

import com.dzy.resteasy.support.config.shardingDatabase.ShardingDataSouceConfig;
...
//@MapperScan(basePackages = "com.dzy.resteasy.mapper")
